...
echo /schedule: lets you loop certain tasks, add "loop" onto the following commands for a loop after running /schedule: /clr, /time, /ip, /date. Example: /dateloop. (must be ran after running /schedule)
